...
use PaymentSystem\Laravel\Nuvei\Jobs\TokenCreateJob;
        ...
        $this->dispatcher
            ...
            ->finally(function (Batch $batch) {
                if ($batch->pendingJobs === $batch->totalJobs) {
                    ...
                    $repository->persist($repository->retrieve($batch->options['id'])->decline('none of acquirers responded successfully'));
                }
            })
            ->dispatch();
    }
